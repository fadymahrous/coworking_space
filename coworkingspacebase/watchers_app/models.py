...
class TofaProductsRepository(models.Model):
    ...
    category = models.ForeignKey(Categorization, on_delete=models.CASCADE,null=False)
...
class TofaProductsOrder(models.Model):
    ...
    item_name = models.ForeignKey(TofaProductsRepository, on_delete=models.CASCADE)
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    ...
    order_number = models.ForeignKey(TofaProductsOrderID, on_delete=models.CASCADE, null=True, blank=True)
